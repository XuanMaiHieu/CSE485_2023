...
CREATE TABLE tacgia(
		ma_tgia INT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL ,
...
CREATE TABLE theloai(
		ma_tloai INT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE baiviet(
		ma_bviet INT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
